...
// import techSkills from "@/data/technicalSkills.json";
...
//   const storedTech = watch("technicalSkills") || [];
...
//   const [selectedTechSkills, setSelectedTechSkills] = useState(storedTech);
//   const [selectedLanguages, setSelectedLanguages] = useState(storedLanguages);
//   const [selectedSoftSkills, setSelectedSoftSkills] = useState(
//     storedSoftSkills || []
//   );
//   const handleRemoveTech = (tech) => {
//     const updatedTech = selectedTechSkills.filter((t) => t !== tech);
//     setSelectedTechSkills(updatedTech);
//     setValue("technicalSkills", updatedTech, { shouldValidate: true });
//   };
...
//           <DropDownPicker
//             style={{
//               zIndex: openTechSkills ? 2000 : 1000,
//               position: "relative",
//             }}
//             open={openTechSkills}
//             setOpen={setOpenTechSkills}
//             multiple={true}
...
//                 setValue("technicalSkills", newSelection, {
//                   shouldValidate: true,
//                 });
//                 return newSelection;
//               });
...
//               const skillLabel = techSkills.find(
//                 (s) => s.value === skill
//               )?.label;
//               return (
//                 <TouchableOpacity
//                   key={skill}
//                   onPress={() => handleRemoveTech(skill)}
